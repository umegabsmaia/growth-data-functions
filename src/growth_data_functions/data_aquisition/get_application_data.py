...
from growth_data_functions.queries.clients_info_queries.build_application_query import build_application_query
...
def get_application_data(
    ...
    query = build_application_query(project, database, table, approved)
