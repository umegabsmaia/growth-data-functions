...
from growth_data_functions.queries.new_queries.build_borrower_settings_query import build_borrower_settings_query

warnings.filterwarnings("ignore")

def get_borrower_settings_query(
    project: str = 'prd-ume-data',
    database: str = 'prd_datastore_public',
    table: str = 'borrowers_settings'
) -> pd.DataFrame:
    ...
    query = build_borrower_settings_query(project, database, table)
