...
from growth_data_functions.queries.clients_info_queries.build_borrowers_query import build_borrowers_query
...
def get_borrowers_data(
    ...
    query = build_borrowers_query(project, database, table)
