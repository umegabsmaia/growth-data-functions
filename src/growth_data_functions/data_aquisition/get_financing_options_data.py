...
from growth_data_functions.queries.new_queries.build_financing_options_query import build_financing_options_query

warnings.filterwarnings("ignore")

def get_financing_options_data(
    project: str = 'prd-ume-data',
    database: str = 'prd_datastore_public',
    table: str = 'financing_options'
) -> pd.DataFrame:
    ...
    query = build_financing_options_query(project, database, table)
