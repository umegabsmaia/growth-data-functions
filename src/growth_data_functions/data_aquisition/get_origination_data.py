...
from growth_data_functions.queries.build_origination_query import build_origination_query
from datetime import datetime, timedelta

warnings.filterwarnings("ignore")

def get_origination_data(
    ...
    query = build_origination_query(project, database, table, start_date, end_date)
