...
from growth_data_functions.queries.new_queries.build_renegotiations_query import build_renegotiations_query

warnings.filterwarnings("ignore")

def get_renegotiations_data(
    project: str = 'prd-ume-data',
    database: str = 'prd_datastore_public',
    table: str = 'renegotiations'
) -> pd.DataFrame:
    ...
    query = build_renegotiations_query(project, database, table)
