...
from growth_data_functions.queries.new_queries.build_retailer_categories_query import build_retailer_categories_query
warnings.filterwarnings("ignore")

def get_retailer_categories_data(
    project: str = 'prd-ume-data',
    database: str = 'prd_datastore_public',
    table: str = 'retailers_categories_retailer_categories'
) -> pd.DataFrame:
    ...
    query = build_retailer_categories_query(project, database, table)
