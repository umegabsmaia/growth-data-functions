...
from growth_data_functions.queries.new_queries.build_run_googleapis_com_stdout_query import build_run_googleapis_com_stdout_query

warnings.filterwarnings("ignore")

def get_run_googleapis_com_stdout_data(
    project: str = 'prd-ume-data',
    database: str = 'prd_bigquery_logs',
    table: str = 'run_googleapis_com_stdout'
) -> pd.DataFrame:
    ...
    query = build_run_googleapis_com_stdout_query(project, database, table)
