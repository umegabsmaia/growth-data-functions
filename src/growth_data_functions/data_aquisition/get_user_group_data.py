...
from growth_data_functions.queries.new_queries.build_user_group_query import build_user_group_query 

warnings.filterwarnings("ignore")

def get_user_group_data(
    project: str = 'prd-ume-data',
    database: str = 'prd_users_users',
    table: str = 'user_group'
) -> pd.DataFrame:
    ...
    query = build_user_group_query(project, database, table)
