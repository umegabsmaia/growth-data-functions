...
from growth_data_functions.queries.new_queries.build_vw_installments_with_taken_limit_query import build_vw_installments_with_taken_limit_query

warnings.filterwarnings("ignore")

def get_vw_installments_with_taken_limit_data(
    project: str = 'prd-ume-data',
    database: str = 'prd_aggregations',
    table: str = 'vw_installments_with_taken_limit'
) -> pd.DataFrame:
    ...
    query = build_vw_installments_with_taken_limit_query(project, database, table)
